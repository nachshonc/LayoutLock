...
/*ssmem_alloc(ssmem_allocator*, unsigned long)'
../../build/bst-aravind.o: In function `bst_cleanup(long)':
bst-aravind.c:(.text+0x537): undefined reference to `ssmem_free(ssmem_allocator*, void*)'
bst-aravind.c:(.text+0x548): undefined reference to `ssmem_free(ssmem_allocator*, void*)'
../../build/bst-aravind.o: In function `bst_insert(long, long, node_t*)':
bst-aravind.c:(.text+0x6d0): undefined reference to `ssmem_alloc(ssmem_allocator*, unsigned long)'
bst-aravind.c:(.text+0x711): undefined reference to `ssmem_alloc(ssmem_allocator*, unsigned long)'
bst-aravind.c:(.text+0x812): undefined reference to `ssmem_free(ssmem_allocator*, void*)'
bst-aravind.c:(.text+0x82a): undefined reference to `ssmem_free(ssmem_allocator*, void*)'
../../build/test.o: In function `test(void*)':
test_simple.c:(.text+0x2b6): undefined reference to `ssmem_alloc_init_fs_size(ssmem_allocator*, unsigned long, unsigned long, int)'
test_simple.c:(.text+0x551): undefined reference to `ssmem_term()

extern "C" {
void ssmem_free(ssmem_allocator*, void *);
void *ssmem_alloc(ssmem_alloctor*, unsigned long);
void ssmem_alloc_init_fs_size(ssmem_allocator*, unsigned long, unsigned long, int);
void ssmem_term();
}*/
